...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    final gifts = MockDataService.getGiftsForEvent(widget.eventId);
    final total = MockDataService.getTotalGifts(widget.eventId);
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(
                  color: AppTheme.goldDark.withOpacity(0.4),
            ...
            if (gifts.isEmpty)
              ...
              ...gifts.asMap().entries.map((entry) {
                ...
                return _transactionTile(gift, i);
              }),
