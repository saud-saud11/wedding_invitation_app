...
class GiftsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final gifts = MockDataService.getGiftsForEvent(eventId);
    final total = MockDataService.getTotalGifts(eventId);
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _summaryItem('إجمالي العانيات', '${total.toStringAsFixed(0)} ر.س'),
            ...
            child: gifts.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      final g = gifts[i];
                      final date = DateFormat('d MMM yyyy', 'ar').format(g.sentAt);
                      return Container(
